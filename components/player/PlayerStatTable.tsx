...
return (
  <>
<View style={{ flexDirection: "row", marginTop: 16, borderRadius: 4, overflow: "hidden" }}>
      {/* Fixed Season Column */}
      <View>
        {/* Header */}
        ...
        {data.map((seasonData, index) => {
          ...
          return (
            <View key={seasonData.season} style={[styles.seasonCell, rowStyle]}>
              <Text style={[styles.cell, isDark && dynamicStyles.textDark]}>
                {seasonData.season}
              </Text>
            </View>
...
container: {
  ...
  cell: {
    ...
    textAlign: "center",
    fontSize: 14,
    fontFamily: OSREGULAR, // ✅ Text style only
    paddingHorizontal: 4,
    
  },
  headerCell: {
    fontFamily: OSBOLD, // ✅ OK because applied to Text
  },
  errorText: {
    color: "red",
  },
