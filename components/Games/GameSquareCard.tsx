  ...
  return (
    ...
    >
            ...
            {isCanceled ? (
              ...
              <>
                ...
                {!game.isHalftime && !isEndOfPeriod && game.clock ? (
                  <Text
                    style={[styles.clock, { color: dark ? "#000" : "#000" }]}
                  >
                    {game.clock}
                  </Text>
                ) : null}
        ...
        <View style={styles.card}>
          ...
          <View style={styles.info}>
            {isCanceled ? (
              ...
              <>
                <Text style={[styles.date, {  fontFamily: Fonts.OSMEDIUM,
      color: isDark ? "#fff" : "#1d1d1d", }]}>
                ...
                <Text style={[styles.time, {       fontFamily: Fonts.OSREGULAR,
      ...
      color: isDark ? "#fff" : "#1d1d1d", }]}>
            ...
            {broadcastNetworks && (
              <Text
                style={[
                  styles.broadcast,
                  { color: dark ? "#fff" : "#000", position: "absolute", top: 2, left: 12 },
                ]}
              >
                {broadcastNetworks}
              </Text>
