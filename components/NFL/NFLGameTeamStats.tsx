...
export default function NFLGameTeamStats({ stats, lighter }: NFLGameTeamStatsProps) {
  ...
  //expects team id as param
  const teamNameA = getTeamInfo(teamA.team.id);
  const teamNameB = getTeamInfo(teamB.team.id);
    ...
    <View>
      ...
      <View style={[styles.logosRow, { borderColor: dividerColor }]}>
        <View style={styles.teamContainer}>
          <Image source={{ uri: teamA.team.logo }} style={styles.logo} />
        ...
        <View style={styles.teamContainer}>
          <Image source={{ uri: teamB.team.logo }} style={styles.logo} />
